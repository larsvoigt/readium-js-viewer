    ...
    var hideLoop = function(e, immediate){
     ...
     var updatePageNumberControls = function(pageChangeData) {
         ...
         var openPage = pageChangeData.paginationInfo.firstOpenPage();
                if (openPage) {
                    //setEditable ??
                    $("#pagination").text(pageChangeData.paginationInfo.getPageNumbers() + " von " + pageChangeData.paginationInfo.getPageCount());
                } else {
                    // setEditable ??
                    $("#pagination").text("keine Seitennumerierung möglich");
                }
     }
