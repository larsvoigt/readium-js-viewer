    ...
    var hideLoop = function(e, immediate){
     ...
     var updatePageNumberControls = function(pageChangeData) {
         ...
         var openPage = pageChangeData.paginationInfo.firstOpenPage();
                if (openPage) {
                    //setEditable ??
                    $("#paginationIndex").text(pageChangeData.paginationInfo.getPageNumbers() + " von " + pageChangeData.paginationInfo.getPageCount());
                } else {
                    // setEditable ??
                    $("#paginationIndex").text("keine Seitennumerierung möglich");
                }
     }
